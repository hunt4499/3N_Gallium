...
class Admin_Controller extends MY_Controller 
{
	...
	public function _upload_image($destination,$img_name,$img_type,$img_tmp_name,$team = null) {
        ...
        if ($photo != "") {
            if ($photo_type == 'image/jpeg' || $photo_type == 'image/pjpeg' ||
                ...
                $photo_path = $team.'image-' . time()  . '.' . $extension;

                move_uploaded_file($img_tmp_name, $destination . $photo_path);
