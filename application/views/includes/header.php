...
<head>
  ...
  <title>3NGallium|Home</title>
  <link rel="stylesheet" href="<?= base_url(); ?>assets/vendors/mdi/css/materialdesignicons.min.css">
  <link rel="stylesheet" href="<?= base_url(); ?>assets/vendors/flag-icon-css/css/flag-icon.min.css">
  <link rel="stylesheet" href="<?= base_url(); ?>assets/vendors/css/vendor.bundle.base.css">
  <link href="https://fonts.googleapis.com/css2?family=Source+Sans+Pro:ital,wght@0,300;0,400;0,600;0,700;0,900;1,700&display=swap" rel="stylesheet">
  ...
  <link rel="shortcut icon" href="<?= base_url(); ?>assets/images/logo-rief.png" />
          ...
          <div class="row">
            <div class="col-md-5">
              <ul class="nav page-navigation">
                <li class="nav-item"> <a class="nav-link" href="<?= base_url(); ?>"> <i class="menu-icon"></i> <span class="menu-title">Home</span> </a> </li>
                <li class="nav-item"> <a class="nav-link" href="<?= base_url(); ?>deals"> <i class="menu-icon"></i> <span class="menu-title">Deals</span> </a> </li>
                <li class="nav-item"> <a class="nav-link" href="<?= base_url(); ?>investers"> <i class="menu-icon"></i> <span class="menu-title">Investors</span> </a> </li>
